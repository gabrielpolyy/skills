---
name: fable-review
description: Review a code delta, existing repository source, or supplied audit evidence with an independent Fable xhigh reviewer, reporting findings without fixes. Use for /fable-review or an explicit request for a Fable review.
---

# Fable review

Run one fresh, read-only review with **fable at xhigh**. The current
