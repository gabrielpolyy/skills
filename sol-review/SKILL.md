---
name: sol-review
description: Review a code delta, existing repository source, or supplied audit evidence with an independent Sol xhigh reviewer, autonomously fixing valid findings and re-reviewing until every finding is fixed or discarded with evidence. Use for /sol-review or an explicit request for a Sol review.
---

# Sol review

Run an autonomous review–fix–test loop using **gpt-5.6-sol at xhigh** for each
