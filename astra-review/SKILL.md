---
name: astra-review
description: Review a code delta, existing repository source, or supplied audit evidence with an independent Astra high reviewer, reporting findings without fixes. Use for /astra-review or an explicit request for a Astra review.
---

# Astra review

Run one fresh, read-only review with **gpt-6-astra at high**. The current
